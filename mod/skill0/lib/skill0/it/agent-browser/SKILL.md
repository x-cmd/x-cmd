...
- [install](../install/SKILL.md) — install/launch via x install channels
- [devloop](../devloop/SKILL.md) — used for visual before/after verification in devloop
- [lovable](../../life/lovable/SKILL.md) — lovable routes web verification through agent-browser
