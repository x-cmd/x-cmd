...
- [rule](../rule/SKILL.md) — naming session is checked via x rule
- [score](../score/SKILL.md) — candidates are scored via score framework
- [ontology-database](../ontology-database/SKILL.md) — selected name persists in ondb
