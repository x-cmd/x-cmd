...
- [install](../install/SKILL.md) — install is one of x-cmd’s channels
- [env](../env/SKILL.md) — env is another x-cmd channel
- [agent-browser](../../it/agent-browser/SKILL.md) — agent-browser is another x-cmd channel
