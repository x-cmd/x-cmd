...
- [rule](../rule/SKILL.md) — rule.yml is the verification skeleton
- [score](../score/SKILL.md) — KR scoring uses score framework
- [install](../install/SKILL.md) — sets up the dev environment
- [agent-browser](../../it/agent-browser/SKILL.md) — visual before/after verification
- [issue](../issue/SKILL.md) — syncs goal + KRs + screenshots to issue tracker
- [repo](../repo/SKILL.md) — pulls/pushes work in repos
- [prompt](../prompt/SKILL.md) — prompt conventions often drive devloop tasks
