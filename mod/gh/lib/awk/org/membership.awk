...
function gh_org_membership_admin_get( o, arr,        kp ){
    kp = SUBSEP Q2_1 SUBSEP Q2_MEMBERSHIP SUBSEP Q2_ADMIN
    arr[L] = jlist_key_value2arr(o, kp, arr, Q2_ADMIN)
}

function gh_org_membership_admin_add( o, username,          kp ){
    kp = SUBSEP Q2_1 SUBSEP Q2_MEMBERSHIP SUBSEP Q2_ADMIN
...
function gh_org_membership_member_add( o, username,            kp ){
    kp = SUBSEP Q2_1 SUBSEP Q2_MEMBERSHIP SUBSEP Q2_MEMBER
    jlist_put(o, kp, username)
}
...
function gh_org_get_membership_list( o, arr){
    gh_org_membership_admin_get(o, arr)
    gh_org_membership_member_get(o, arr)
}
...
function gen_code_membership_add(username, role){
    MEMBER_ADD_STR = MEMBER_ADD_STR   "\n" sh_x("gh", "org", "membership", "add", "--org", LOCAL_ORG_NAME, "--permission", role, username)
}
function gen_code_membership_edit(username, role){
    MEMBER_EDIT_STR = MEMBER_EDIT_STR "\n" sh_x("gh", "org", "membership", "edit", "--org", LOCAL_ORG_NAME, "--permission", role, username)
}
