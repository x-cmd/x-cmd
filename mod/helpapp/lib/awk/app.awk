...
function tapp_init(){
    ...
    HELP_SHORT_MODE = ENVIRON[ "___X_CMD_HELP_SHORT_MODE" ]
    HELP_SHORT_LIMIT = ENVIRON[ "___X_CMD_HELP_SHORT_LIMIT" ]
    print_helpdoc_init(IS_TH_NO_COLOR, TH_HETHEME_NAME_COLOR, TH_HETHEME_DESC_COLOR, TH_HETHEME_TITLE_COLOR,
        ...
        TH_HELP_POSITION_ORDER, TH_HELP_POSITION_ORDER_ARR, HELP_SHORT_MODE, HELP_SHORT_LIMIT)
    APPKP = "helpapp_kp"
