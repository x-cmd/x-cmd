...
NR==2{
    ...
    gh_org_get_membership_list( LOCAL_OBJ, LOCAL_MEMBERSHIP_LIST )
...
NR==3{
    ...
    gh_api_to_name( REMOTE_OBJ, _);     delete _
...
NR==4{
    jiparse_after_tokenize( _, $0 );    JITER_CURLEN = 0;
    gh_api_to_membership(REMOTE_OBJ, _, Q2_ADMIN);    delete _

    gh_org_get_membership_list( REMOTE_OBJ, REMOTE_MEMBERSHIP_LIST )
...
NR==5{
    jiparse_after_tokenize( _, $0 );    JITER_CURLEN = 0;
    gh_api_to_membership(REMOTE_OBJ, _, Q2_MEMBER);    delete _
