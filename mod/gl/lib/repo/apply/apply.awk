...
NR==2{
    ...
    gl_repo_get_member_list( LOCAL_OBJ, LOCAL_COLLABORATOR_LIST )
...
NR==3{
    ...
    gl_repo_get_member_list( REMOTE_OBJ, REMOTE_COLLABORATOR_LIST )
}
