...
function draw_form_style_init(){
    ...
    TH_FORM_UNMATCHED          = ( IS_TH_CUSTOM ) ? ENVIRON[ "___X_CMD_TUI_TH_FORM_UNMATCHED" ]           : UI_FG_BRIGHT_RED
    TH_FORM_INTERVAL_STYLE     = ( IS_TH_CUSTOM ) ? ENVIRON[ "___X_CMD_TUI_TH_FORM_INTERVAL_STYLE" ]      : TH_THEME_COLOR " : " UI_END
