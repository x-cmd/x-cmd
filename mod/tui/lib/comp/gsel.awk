...
function comp_gsel_handle( o, kp, char_value, char_name, char_type ) {
    ...
    if (char_name == U8WC_NAME_UP)                      ctrl_page_rdec(o, kp)
        ...
        if (char_name == U8WC_NAME_CARRIAGE_RETURN) comp_gsel_filter_sw_toggle(o, kp)
            ...
            comp_gsel_cell_selected_sw_toggle(o, kp, comp_gsel_focused_item_true_get( o, kp ))
            ctrl_page_rinc(o, kp)
        }
        else if (comp_gsel_slct_set( o, kp, char_value, char_name, char_type )) {
...
# Section: gsel model
function comp_gsel_handle_slct(o, kp,          s, l, i, _viewl ){
    s = comp_gsel_slct_get( o, kp )
...
function comp_gsel_slct_set( o, kp, char_value, char_name, char_type ){
    return comp_lineedit_handle(o, kp SUBSEP "select", char_value, char_name, char_type)
}
function comp_gsel_slct_get( o, kp ){
    return comp_lineedit_get(o, kp SUBSEP "select")
}
function comp_gsel_slct_get_with_cursor( o, kp, x1, y1, y2 ){
...
function comp_gsel_cell_selected_set( o, kp, i, tf ){
...
function comp_gsel_selected_len(o, kp){
    return model_arr_data_len( o, kp SUBSEP "selected" )
}

function comp_gsel_get_selected_item(o, kp,         i, l, v){
    l = comp_gsel_selected_len(o, kp)
    for (i=1; i<=l; ++i) v = ((v) ? v "\n" : "") comp_gsel_data_get(o, kp, model_arr_data_get(o, kp SUBSEP "selected", i))
    return v
}

function comp_gsel_cell_is_selected( o, kp, i ){
    return o[ kp, "data-arr", "data", i, "SELECTED" ]
}

function comp_gsel_cell_selected_sw_toggle( o, kp, i,           l ){
    if (comp_gsel_cell_is_selected( o, kp, i ))  comp_gsel_cell_selected_set(o, kp, i, false )
    else if (( (l=o[ kp, "limit" ]) == "no-limit" ) || l > comp_gsel_selected_len( o, kp ))
        comp_gsel_cell_selected_set(o, kp, i, true)
}
# EndSection
...
function comp_gsel_paint_body( o, kp, x1, x2, y1, y2,       r, w, iw, ps, l, i, _start, _end, _comp_body ){
    ...
    for (i=_start; i<=_end; ++i){
        _comp_body = _comp_body comp_gsel_paint_cell( o, kp, i, iw ) \
            ( (i%r != 0) ? "\r\n" : "\r" painter_up(r-1) ) \
...
function comp_gsel_paint_cell( o, kp, i, w,         v, ri){
    ...
    if (comp_gsel_cell_is_selected( o, kp, ri )) v = TH_GSEL_ITEM_SELECTED_PREFIX th( TH_GSEL_ITEM_SELECTED, v )
