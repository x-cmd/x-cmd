...
Now there are more than **314** [modules](https://x-cmd.com/mod), **more than 577** [packages](https://x-cmd.com/pkg), and **more than 1588** [install](https://www.x-cmd.com/install/) receipes ~
